...
var author$project$Main$Summary = F4(
	function (name, amount, gains, percentage) {
		return {amount: amount, gains: gains, name: name, percentage: percentage};
	});
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			emailInput: '',
			page: author$project$Main$Guest,
			passwordInput: '',
			summary: A4(author$project$Main$Summary, '', '', '', '')
		},
...
var author$project$Main$GotAuthentication = function (a) {
	return {$: 'GotAuthentication', a: a};
};
var author$project$Main$Credentials = F2(
	function (token, id) {
...
var author$project$Main$loginEncoder = F2(
...
var author$project$Main$userLogin = F2(
	function (email, password) {
		var body = elm$http$Http$jsonBody(
			A2(author$project$Main$loginEncoder, email, password));
		return elm$http$Http$post(
			{
				body: body,
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotAuthentication, author$project$Main$authenticationDecoder),
				url: 'http://localhost:4000/api/v1/users/tokens'
			});
	});
var author$project$Main$GotUserSummary = function (a) {
	return {$: 'GotUserSummary', a: a};
};
var elm$json$Json$Decode$map4 = _Json_map4;
var author$project$Main$userSummaryDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Main$Summary,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'amount', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'gains', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'percentage', elm$json$Json$Decode$string));
...
var author$project$Main$userSummary = F2(
	function (token, userId) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$emptyBody,
				expect: A2(elm$http$Http$expectJson, author$project$Main$GotUserSummary, author$project$Main$userSummaryDecoder),
				headers: _List_fromArray(
					[
						A2(elm$http$Http$header, 'Accept', 'application/vnd.api+json; version=1'),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DispatchLogin':
				return _Utils_Tuple2(
					model,
					A2(author$project$Main$userLogin, model.emailInput, model.passwordInput));
			case 'GotAuthentication':
				if (msg.a.$ === 'Ok') {
					var data = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$Authorized(data)
							}),
						A2(author$project$Main$userSummary, data.token, data.id));
				} else {
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								summary: A4(author$project$Main$Summary, data.name, data.amount, data.gains, data.percentage)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Main$authorizedView = F2(
	function (model, token) {
		var percentageLocale = A7(cuducos$elm_format_number$FormatNumber$Locales$Locale, 1, '.', ',', '-', '', '+', '');
		var gainLocale = A7(cuducos$elm_format_number$FormatNumber$Locales$Locale, 2, '.', ',', '− R$ ', '', '+ R$ ', '');
		var amountLocale = A7(cuducos$elm_format_number$FormatNumber$Locales$Locale, 2, '.', ',', '−', '', '', '');
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('text-grey-lighter text-center')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('text-grey-light')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Minha carteira')
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							function () {
							var _n0 = elm$core$String$toFloat(model.summary.amount);
							if (_n0.$ === 'Just') {
								var amount = _n0.a;
								return A2(
									elm$html$Html$div,
									...
									_List_fromArray(
										[
											elm$html$Html$text(
											'R$ ' + A2(cuducos$elm_format_number$FormatNumber$format, amountLocale, amount))
										]));
							} else {
								return A2(
									elm$html$Html$div,
					...
					_List_fromArray(
						[
							function () {
							var _n1 = elm$core$String$toFloat(model.summary.percentage);
							if (_n1.$ === 'Just') {
								var percentage = _n1.a;
								var formattedPercentage = A2(cuducos$elm_format_number$FormatNumber$format, percentageLocale, percentage * 100) + '%';
								return (percentage > 0) ? A2(
									elm$html$Html$div,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											elm$html$Html$text(formattedPercentage)
										])) : A2(
									elm$html$Html$div,
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('text-red-light')
										]),
									_List_fromArray(
										[
											elm$html$Html$text(formattedPercentage)
							...
							function () {
							var _n2 = elm$core$String$toFloat(model.summary.gains);
							if (_n2.$ === 'Just') {
								var gains = _n2.a;
								return A2(
									elm$html$Html$div,
									...
									_List_fromArray(
										[
											elm$html$Html$text(
											A2(cuducos$elm_format_number$FormatNumber$format, gainLocale, gains))
										]));
							} else {
								return A2(
									elm$html$Html$div,
...
var author$project$Main$EmailInputChanged = function (a) {
	return {$: 'EmailInputChanged', a: a};
};
...
var author$project$Main$guestView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$class('w-full max-w-xs px-4 py-8')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('block text-grey text-xs font-bold mb-1'),
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onInput(author$project$Main$EmailInputChanged),
										elm$html$Html$Attributes$value(model.emailInput),
										elm$html$Html$Attributes$class('shadow appearance-none bg-grey-darkest rounded w-full py-2 px-3 text-grey-dark leading-tight focus:outline-none focus:shadow-outline'),
										elm$html$Html$Attributes$id('email'),
										elm$html$Html$Attributes$placeholder('Digite seu email'),
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$placeholder('Digite sua senha'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('w-full bg-blue hover:bg-blue-dark text-white font-semibold py-4 px-4 rounded-sm focus:outline-none focus:shadow-outline'),
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('w-full min-h-screen flex flex-col items-center justify-center bg-black pt-8')
					]),
				_List_fromArray(
					[
						function () {
						var _n0 = model.page;
						if (_n0.$ === 'Guest') {
							return author$project$Main$guestView(model);
						} else {
							var token = _n0.a.token;
							return A2(author$project$Main$authorizedView, model, token);
						}
					}()
					]))
			]),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Credentials":{"args":[],"type":"{ token : String.String, id : String.String }"},"Main.Summary":{"args":[],"type":"{ name : String.String, amount : String.String, gains : String.String, percentage : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"EmailInputChanged":["String.String"],"PasswordInputChanged":["String.String"],"DispatchLogin":[],"GotAuthentication":["Result.Result Http.Error Main.Credentials"],"GotUserSummary":["Result.Result Http.Error Main.Summary"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));